...
{
    public partial class GeographicController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public GeographicController() { }

        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected GeographicController(Dummy d) { }
        ...
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public virtual System.Web.Mvc.ContentResult Js()
        {
            return new T4MVC_System_Web_Mvc_ContentResult(Area, Name, ActionNames.Js);
        }

        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public GeographicController Actions { get { return MVC.Geographic; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Geographic";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Geographic";
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_GeographicController : YekanPedia.ManagementSystem.Console.Controllers.GeographicController
    {
        public T4MVC_GeographicController() : base(Dummy.Instance) { }
