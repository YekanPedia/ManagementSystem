...
{
    public partial class IELTSController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected IELTSController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public IELTSController Actions { get { return MVC.IELTS; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "IELTS";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "IELTS";
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public class ActionParamsClass_SendWrittingFile
        {
    ...
    public partial class T4MVC_IELTSController : YekanPedia.ManagementSystem.Console.Controllers.IELTSController
    {
        ...
        [NonAction]
        public override System.Web.Mvc.ViewResult SendWrittingFile()
        {
            var callInfo = new T4MVC_System_Web_Mvc_ViewResult(Area, Name, ActionNames.SendWrittingFile);
            SendWrittingFileOverride(callInfo);
            return callInfo;
        }

        [NonAction]
        partial void UserFilesListOverride(T4MVC_System_Web_Mvc_PartialViewResult callInfo);

        [NonAction]
        public override System.Web.Mvc.PartialViewResult UserFilesList()
        {
            var callInfo = new T4MVC_System_Web_Mvc_PartialViewResult(Area, Name, ActionNames.UserFilesList);
            UserFilesListOverride(callInfo);
            return callInfo;
        }

        [NonAction]
        partial void SendWrittingFileOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, YekanPedia.ManagementSystem.Domain.Entity.IeltsMaterial model, System.Web.HttpPostedFileBase file);

        [NonAction]
        public override System.Web.Mvc.ActionResult SendWrittingFile(YekanPedia.ManagementSystem.Domain.Entity.IeltsMaterial model, System.Web.HttpPostedFileBase file)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.SendWrittingFile);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "file", file);
            SendWrittingFileOverride(callInfo, model, file);
            return callInfo;
        }

        [NonAction]
        partial void DeleteOverride(T4MVC_System_Web_Mvc_JsonResult callInfo, System.Guid ieltsMaterialId, string path);

        [NonAction]
        public override System.Web.Mvc.JsonResult Delete(System.Guid ieltsMaterialId, string path)
        {
