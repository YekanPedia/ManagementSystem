    ...
    */
    ...
    Grid.defaults = {
        ...
        css: {
            ...
            dropDownMenuItems: "dropdown-menu pull-left", // must be a unique class name or constellation of class names within the actionDropDown
        ...
        labels: {
            all: "کل",
            infos: "نمایش {{ctx.start}} تا {{ctx.end}} از {{ctx.total}} رکورد",
            loading: "در حال بارگذاری اطلاعات",
            noResults: "!هیچ رکوردی یافت نشد",
            refresh: "بروز رسانی",
            search: "جستجو"
        },
        ...
        templates: {
            ...
            search: "<div class=\"{{css.search}}\"><div class=\"input-group\"> <input type=\"text\" class=\"{{css.searchField}}\" placeholder=\"{{lbl.search}}\" /><span class=\"{{css.icon}} input-group-addon glyphicon-search\"></span></div></div>",
